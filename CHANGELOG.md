...
### Changed
- **Documentation:** Consolidated visitor templating into **[`docs/development/TEMPLATING.md`](docs/development/TEMPLATING.md)** (requirements, page builder/theming, tasks checklist, §8 pack appendix) and page-builder module authoring into **[`docs/development/PAGE_BUILDER_MODULES.md`](docs/development/PAGE_BUILDER_MODULES.md)**. Legacy filenames (`TEMPLATING_REQUIREMENTS.md`, `TEMPLATING_TASKS.md`, `THEMING.md`, `UI_COMPONENT_MODULES.md`, `MODULE_URL_PARAMS.md`) remain as short redirects.
