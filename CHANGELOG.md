...
### Added
- **Admin UI Phase 5 (platform):** [`frontend/src/lib/admin/README.md`](frontend/src/lib/admin/README.md) index; [`ADMIN_INTERACTION_PATTERNS.md`](frontend/src/lib/admin/ADMIN_INTERACTION_PATTERNS.md) (forms, toasts, confirms, drawers, `AdminSortableList` usage); [`ADMIN_TOAST_CONFIRM_AUDIT.md`](frontend/src/lib/admin/ADMIN_TOAST_CONFIRM_AUDIT.md) route snapshot; [`form-errors.ts`](frontend/src/lib/admin/form-errors.ts) (`submitErrorMessage`, `fieldHintFromApiError`); [`AdminSortableList.svelte`](frontend/src/lib/components/admin/AdminSortableList.svelte). Roadmap checklist **A** updated in [`docs/archive/development/ADMIN_UI_ROADMAP.md`](docs/archive/development/ADMIN_UI_ROADMAP.md).
