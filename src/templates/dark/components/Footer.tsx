  ...
  return (
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              <div className="flex items-center space-x-3 mb-4">
                {config?.logo ? (
                  <div className="relative w-8 h-8 rounded overflow-hidden ring-2 ring-gray-700">
                    <Image
                      src={config.logo}
              ...
              <div 
                ...
                dangerouslySetInnerHTML={{ 
                  ...
                  '<p>A sophisticated dark photo gallery platform for showcasing your memories with style.</p>'
                }}
              />
            </div>
        ...
        <div className={`border-t border-gray-800 ${isComponentVisible('footerMenu') ? 'pt-8' : 'pt-4'}`}>
