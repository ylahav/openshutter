        ...
        {isComponentVisible('footerMenu') && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div 
                className="styles.text-secondary text-sm leading-relaxed"
            ...
            {/* Gallery links */}
            <div>
              <h3 className="text-sm font-semibold styles.text mb-4">
              ...
              <ul className="space-y-2">
                {footerLinks.gallery.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-sm styles.text-secondary hover:styles.text transition-colors duration-300 hover:translate-x-1 transform inline-block"
                    >
                      {link.name}
                    </Link>
                  </li>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                {config?.contact?.socialMedia?.twitter && (
                  <a href={config.contact.socialMedia.twitter} target="_blank" rel="noopener noreferrer" className="styles.text-secondary hover:styles.text transition-colors duration-300">
                ...
                {config?.contact?.socialMedia?.facebook && (
                  <a href={config.contact.socialMedia.facebook} target="_blank" rel="noopener noreferrer" className="styles.text-secondary hover:styles.text transition-colors duration-300">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                {config?.contact?.socialMedia?.instagram && (
                  <a href={config.contact.socialMedia.instagram} target="_blank" rel="noopener noreferrer" className="styles.text-secondary hover:styles.text transition-colors duration-300">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                {config?.contact?.socialMedia?.linkedin && (
                  <a href={config.contact.socialMedia.linkedin} target="_blank" rel="noopener noreferrer" className="styles.text-secondary hover:styles.text transition-colors duration-300">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
