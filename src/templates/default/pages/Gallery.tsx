        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            <div className="text-center py-12">
              ...
              <p className="mt-4 text-muted-foreground">{t('loadingAlbums')}</p>
            </div>
          ) : error ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-foreground mb-2">{t('errorLoadingAlbums')}</h3>
            ...
            <div className="text-center py-12">
              ...
              <h3 className="mt-2 text-lg font-medium text-foreground">{t('noAlbumsYet')}</h3>
