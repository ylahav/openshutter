    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">{t('admin.adminPanel')}</h1>
            <p className="text-gray-600 mt-2">{t('admin.manageGallerySettings')}</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('admin.siteConfiguration')}</h2>
            </div>
            <p className="text-gray-600 mb-4">
              {t('admin.configureGallery')}
            </p>
            <Link
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('admin.storageManagement')}</h2>
            </div>
            <p className="text-gray-600 mb-4">
              {t('admin.configureStorage')}
            </p>
            <Link
              href="/admin/storage"
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('admin.templateManagement')}</h2>
            </div>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('admin.albumsManagement')}</h2>
            </div>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">People Management</h2>
            </div>
            <p className="text-gray-600 mb-4">
              Manage people who appear in your photos with structured data
            </p>
            <Link
              href="/admin/people"
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">Tags Management</h2>
            </div>
            <p className="text-gray-600 mb-4">
              Manage tags for categorizing and organizing your photos with structured data
            </p>
            <Link
              href="/admin/tags"
              className="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">Location Management</h2>
            </div>
            <p className="text-gray-600 mb-4">
              Manage locations for your photos with structured data including coordinates and addresses
            </p>
            <Link
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('admin.usersManagement')}</h2>
            </div>
            <p className="text-gray-600 mb-4">{t('admin.manageUsersRoles')}</p>
            <Link
              href="/admin/users"
              className="inline-flex items-center px-4 py-2 bg-slate-700 text-white rounded-md hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2"
            >
              {t('admin.manageUsers')}
              <svg className="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={getArrowPath()} />
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('admin.groupsManagement')}</h2>
            </div>
            <p className="text-gray-600 mb-4">{t('admin.defineUserGroups')}</p>
            <Link
              href="/admin/groups"
          ...
          {/* Import & Sync - Temporarily disabled */}
          {/* <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('admin.importSync')}</h2>
            </div>
            <p className="text-gray-600 mb-4">
              {t('admin.importSyncDescription')}
            </p>
            <Link
              href="/admin/import-sync"
              className="inline-flex items-center px-4 py-2 bg-cyan-600 text-white rounded-md hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2"
            >
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('admin.backupRestore')}</h2>
            </div>
            <p className="text-gray-600 mb-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('admin.analytics')}</h2>
            </div>
            <p className="text-gray-600 mb-4">
