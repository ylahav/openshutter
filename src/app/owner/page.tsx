      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">
              {isAdmin ? t('admin.adminPanel') : t('owner.ownerPanel')}
            </h1>
            <p className="text-gray-600 mt-2">
              {isAdmin ? t('admin.manageGallerySettings') : t('owner.manageYourAlbums')}
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {isOwner && (
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('owner.profileManagement')}</h2>
              </div>
              <p className="text-gray-600 mb-4">
                {t('owner.editProfileDescription')}
              </p>
              <Link
                href="/owner/profile"
                className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            >
              {isAdmin ? t('admin.manageAlbums') : t('owner.manageMyAlbums')}
              <svg className="ml-2 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={getArrowPath()} />
              </svg>
            </Link>
          ...
          {isOwner && (
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex items-center mb-4">
                ...
                <h2 className="text-xl font-semibold text-gray-900 ml-3">{t('owner.blogManagement')}</h2>
              </div>
              <p className="text-gray-600 mb-4">
                {t('owner.createEditBlogArticles')}
              </p>
              <Link
                href="/owner/blog"
