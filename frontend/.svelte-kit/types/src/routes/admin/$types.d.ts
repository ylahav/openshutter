...
type LayoutRouteId = RouteId | "/admin" | "/admin/albums" | "/admin/albums/[id]" | "/admin/albums/[id]/edit" | "/admin/analytics" | "/admin/backup-restore" | "/admin/blog-categories" | "/admin/deployment" | "/admin/groups" | "/admin/locations" | "/admin/pages" | "/admin/people" | "/admin/photos/[id]/edit" | "/admin/site-config" | "/admin/storage" | "/admin/tags" | "/admin/templates" | "/admin/templates/overrides" | "/admin/users"
