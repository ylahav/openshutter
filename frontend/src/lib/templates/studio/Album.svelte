...
{:else if albumData}
	<div class="min-h-screen w-full pt-24 pb-12 bg-[color:var(--tp-canvas)] text-[color:var(--tp-fg)] [font-family:var(--os-font-body)]">
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-12">
			...
			{#if albumData.album}
				<div class="pb-4 mb-6 border-b border-[color:var(--tp-border)]">
			...
			<div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
				<div class="flex-1">
					<h1
						class="text-4xl md:text-5xl font-extralight mb-6 tracking-tight text-[color:var(--tp-fg)]"
					...
					{#if albumData.album.description}
						<div
							class="prose prose-lg max-w-4xl mx-auto mb-4 [&_*]:!text-[color:var(--tp-fg-muted)] [&_a]:!text-[color:var(--tp-fg)]"
						>
