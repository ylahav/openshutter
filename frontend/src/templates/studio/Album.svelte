...
{:else if albumData}
	<div class="min-h-screen w-full pt-24 pb-12 bg-(--tp-canvas) text-(--tp-fg) [font-family:var(--os-font-body)]">
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-12">
			...
			{#if albumData.album}
				<div class="pb-4 mb-6 border-b border-(--tp-border)">
			...
			<div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
				<div class="flex-1">
					<h1
						class="text-4xl md:text-5xl font-extralight mb-6 tracking-tight text-(--tp-fg)"
					...
					{#if albumData.album.description}
						<div
							class="prose prose-lg max-w-4xl mx-auto mb-4 **:text-(--tp-fg-muted)! [&_a]:text-(--tp-fg)!"
						>
				...
				<div class="columns-1 sm:columns-2 lg:columns-3 gap-6">
					{#each albumData.photos as photo, index}
						...
						>
							...
							>
								<div
									class="bg-linear-to-b relative overflow-hidden rounded-lg from-(--tp-surface-2) to-(--tp-surface-3)"
