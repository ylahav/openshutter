import { h as head, b as attr, e as ensure_array_like, d as bind_props } from './index2-ConC1ezP.js';
...
_page[FILENAME] = "src/routes/admin/tags/+page.svelte";
function _page($$renderer, $$props) {
  $$renderer.component(
    ($$renderer2) => {
      ...
      $$renderer2.push(`<!--]--> <div class="flex items-center justify-between mb-6">`);
      push_element($$renderer2, "div", 291, 3);
      $$renderer2.push(`<div class="flex items-center space-x-4">`);
      push_element($$renderer2, "div", 292, 4);
      $$renderer2.push(`<div class="relative">`);
      push_element($$renderer2, "div", 293, 5);
      $$renderer2.push(`<input type="text" placeholder="Search tags..."${attr("value", searchTerm)} class="pl-10 pr-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-64"/>`);
      push_element($$renderer2, "input", 294, 6);
      pop_element();
      ...
      push_element($$renderer2, "svg", 301, 6);
      ...
      push_element($$renderer2, "path", 307, 7);
      $$renderer2.push(`</path>`);
      pop_element();
      $$renderer2.push(`</svg>`);
      pop_element();
      ...
      $$renderer2.select(
        ...
        ($$renderer3) => {
          ...
          $$renderer3.push(`<!--[-->`);
          const each_array = ensure_array_like(TAG_CATEGORIES);
...
//# sourceMappingURL=_page.svelte-c924Dnw2.js.map
