import { s as set, L as LEGACY_PROPS, g as get, f as flushSync, d as define_property, m as mutable_source, i as init_operations, a as get_first_child, C as COMMENT_NODE, b as get_next_sibling, c as clear_text_content, S as STATE_SYMBOL, e as state_proxy_unmount, l as lifecycle_double_unmount, h as hydration_mismatch, j as array_from, k as component_root, n as set_active_reaction, o as set_active_effect, p as active_effect, q as active_reaction, r as create_text, t as setContext, u as block, v as branch, B as Batch, w as pause_effect, x as set_component_context, y as handle_error, z as component_context, A as move_effect, D as internal_set, E as destroy_effect, F as invoke_error_boundary, G as queue_micro_task, H as tag, I as source, J as effect_tracking, K as render_effect, M as svelte_boundary_reset_noop, N as untrack, O as increment, P as push$1, Q as pop$1, R as EFFECT_TRANSPARENT, T as EFFECT_PRESERVED, U as BOUNDARY_EFFECT, V as DEV, W as readable, X as writable } from './chunks/index-BI-RhdSw.js';
import { t as text, R as Redirect, S as SvelteKitError, H as HttpError, j as json, e as error, A as ActionFailure } from './chunks/index-wpIsICWW.js';
import { t as text_decoder, b as base64_decode, d as decode_pathname, a as decode_params, v as validate_server_exports, n as normalize_path, c as disable_search, w as with_request_store, e as validate_layout_server_exports, f as validate_layout_exports, g as validate_page_server_exports, h as validate_page_exports, i as text_encoder, r as resolve, m as make_trackable, j as get_relative_path, k as base64_encode, S as SCHEME, l as try_get_request_store } from './chunks/exports-Dc4PPDXS.js';
import { s as set_private_env, a as set_public_env, p as public_env, f as fix_stack_trace } from './chunks/shared-server-cF6ckHns.js';
import { H as HYDRATION_START, a as HYDRATION_ERROR, h as hydration_failed, F as FILENAME, s as svelte_boundary_reset_onerror, b as HYDRATION_END, c as HYDRATION_START_ELSE } from './chunks/index-client-CjQNkNPT.js';
import { r as render, i as is_passive_event, p as prevent_snippet_stringification } from './chunks/index2-ConC1ezP.js';
import 'clsx';
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./chunks/hooks.server-BTGXfJVC.js'));
  let reroute;
  let transport;
  return {
    handle,
...
function get_cookies(request, url) {
  ...
  function set_internal(name, value, options2) {
    ...
    {
      const serialized = cookieExports.serialize(name, value, cookie2.options);
