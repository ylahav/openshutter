...
let AlbumsService = class AlbumsService {
     ...
     */
    getHierarchy() {
        return __awaiter(this, arguments, void 0, function* (includePrivate = false) {
            const query = {};
            ...
            for (const album of allAlbums) {
                const albumData = Object.assign(Object.assign({}, album), { _id: album._id.toString(), parentAlbumId: album.parentAlbumId ? album.parentAlbumId.toString() : null, coverPhotoId: album.coverPhotoId ? (album.coverPhotoId._id ? album.coverPhotoId._id.toString() : album.coverPhotoId.toString()) : null, createdBy: album.createdBy ? album.createdBy.toString() : null, children: [] });
