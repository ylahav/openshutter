...
- **Deliverable:** Design doc (e.g. `./design/IMPORT_SYNC_DESIGN.md`) defining external package format (DB reflection + tree), import/export flow, and storage migration + ADR if needed.
...
- **Deliverable:** Design doc (e.g. `./design/AI_TAGGING_DESIGN.md`) with chosen approach and API contract.
- **Status:** ✅ Design document created (`./design/AI_TAGGING_DESIGN.md`)
...
- **Deliverable:** Feature behind admin/owner role; see `./design/AI_TAGGING_DESIGN.md`.
...
- **Deliverable:** Analytics design doc with metric definitions and retention. ✅ See `./design/ADVANCED_ANALYTICS_DESIGN.md`
...
- **Deliverable:** API product doc and marketplace concept (e.g. `./design/API_MARKETPLACE.md`).
- **Status:** ✅ Design document created (`./design/API_MARKETPLACE.md`)
...
- **Deliverable:** Design doc (e.g. `./design/SMART_TAG_SUGGESTIONS_DESIGN.md`) linking to Stage 2 and existing search/tag implementation.
- **Status:** ✅ Design document created (`./design/SMART_TAG_SUGGESTIONS_DESIGN.md`)
...
- [SYSTEM_PRD.md](../../development/SYSTEM_PRD.md) – Phase 3 roadmap, §6 Repository Import System
